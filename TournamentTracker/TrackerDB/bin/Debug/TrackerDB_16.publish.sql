...
GO
/*
The column [dbo].[Tournament].[Active] on table [dbo].[Tournament] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/

IF EXISTS (select top 1 1 from [dbo].[Tournament])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering Table [dbo].[Tournament]...';
...
GO
PRINT N'Refreshing Procedure [dbo].[spTournament_Insert]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spTournament_Insert]';
