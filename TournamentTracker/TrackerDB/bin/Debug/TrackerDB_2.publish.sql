...
GO
PRINT N'Altering Procedure [dbo].[spPrize_GetByTournament]...';


GO
ALTER PROCEDURE [dbo].[spPrize_GetByTournament]
	@TournamentId int
AS
begin
	SET NOCOUNT ON;

	select [Id], [FirstName], [LastName], [EmailAddres], [CellphoneNumber]
	from dbo.Person
